...
typedef uint32_t EidolonSceneInteractionPolicy;

enum EidolonSceneInteractionFlag {
    EIDOLON_SCENE_INTERACTION_PASS_THROUGH,
    EIDOLON_SCENE_INTERACTION_ACTIVATE = UINT32_C(1) << 0,
    EIDOLON_SCENE_INTERACTION_MOVE_ANCHOR = UINT32_C(1) << 1,
    EIDOLON_SCENE_INTERACTION_ROUTE_POINTER = UINT32_C(1) << 2,
    EIDOLON_SCENE_INTERACTION_PRIMARY_MASK =
        EIDOLON_SCENE_INTERACTION_ACTIVATE | EIDOLON_SCENE_INTERACTION_MOVE_ANCHOR,
    EIDOLON_SCENE_INTERACTION_ALL =
        EIDOLON_SCENE_INTERACTION_PRIMARY_MASK | EIDOLON_SCENE_INTERACTION_ROUTE_POINTER,
};
